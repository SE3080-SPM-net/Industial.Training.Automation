...
namespace Industial.Training.Automation.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            RegisterStudentViewModel viewModel = PopulateStudentRegisterViewModel();
        ...
        public async Task<ActionResult> RegisterInstructor(RegisterInstructorViewModel model)
        {
            ...
            List<IdentityRole> roles;
            RegisterInstructorViewModel viewModel = new RegisterInstructorViewModel();
        ...
        private RegisterInstructorViewModel PopulateInstructorRegisterViewModel()
        {
            List<IdentityRole> roles;
            RegisterInstructorViewModel viewModel = new RegisterInstructorViewModel();
